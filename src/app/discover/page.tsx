...
import {
  MapPin, Calendar, Search, Plus, FolderKanban, Layers, ClipboardList,
  Grid3x3, List, LayoutGrid, ChevronRight, ChevronDown, Eye, Heart,
  Download, MessageCircle, TrendingUp, Users, Package, Clock, CheckCircle2,
  AlertCircle, Edit3, FileCheck, Circle, Activity, Filter, ArrowUpDown,
  BarChart3, Kanban, Star
} from "lucide-react";

// Project phases for kanban view
const projectPhases = [
...
// Assign mock phases to projects
